...
function DeviceUUID(options) {
    ...
    this._Versions = {
        ...
        Chrome: /chrome\/([\w.\-]+)/i,
        Chromium: /(?:chromium|crios)\/([\w.\-]+)/i,
        Safari: /version\/([\w.\-]+)/i,
        Opera: /version\/([\w.\-]+)|OPR\/([\w.\-]+)/i,
        Ps3: /([\w.\-]+)\)\s*$/i,
        Psp: /([\w.\-]+)\)?\s*$/i,
        Amaya: /amaya\/([\w.\-]+)/i,
        SeaMonkey: /seamonkey\/([\w.\-]+)/i,
        OmniWeb: /omniweb\/v([\w.\-]+)/i,
        Flock: /flock\/([\w.\-]+)/i,
        Epiphany: /epiphany\/([\w.\-]+)/i,
        WinJs: /msapphost\/([\w.\-]+)/i,
        PhantomJS: /phantomjs\/([\w.\-]+)/i,
        UC: /UCBrowser\/([\w.]+)/i
    };
    this._Browsers = {
        Edge: /edge/i,
    ...
    this.DefaultAgent = {
        ...
        hashMD5: function (string) {
            ...
            for (k = 0; k < x.length; k += 16) {
                ...
                CC = c;
                DD = d;
                a = gFF(a, b, c, d, x[k], S11, 0xD76AA478);
                ...
                b = gGG(b, c, d, a, x[k], S24, 0xE9B6C7AA);
                ...
                d = gHH(d, a, b, c, x[k], S32, 0xEAA127FA);
                ...
                a = gII(a, b, c, d, x[k], S41, 0xF4292244);
    ...
    this.getBrowser = function (string) {
        switch (true) {
            ...
            default:
                ...
                if (string.indexOf('Mozilla') !== 0 && /^([\w\-.]+)\/[\w.\-]+/i.test(string)) {
...
module.exports = new DeviceUUID(navigator.userAgent);
